...
export const WORKS: WorkItem[] = [
  // --- Product Design ---
  {
    ...
    image: '/images/product_1_books_key_holder.png',
  ...
  },
  {
    ...
    category: 'Product Design',
    image: '/images/product_2_pouch_pen_stand.png',
  ...
  },
  {
    ...
    category: 'Product Design',
    image: '/images/product_3_messy_pani_puri.png',
  ...
  // --- Posters & Typography ---
  {
    ...
    image: '/images/communication_truth_by_design.png',
  ...
  },
  {
    ...
    category: 'Posters & Typography',
    image: '/images/communication_abstract_composition_on_myself.png',
  ...
  },
  {
    ...
    category: 'Posters & Typography',
    image: '/images/typography_empathy_trait.png',
  ...
  },
  {
    ...
    category: 'Posters & Typography',
    image: '/images/posters_overview.png',
  ...
  // --- Fashion Design ---
  {
    ...
    image: '/images/fashion_navi_vogue.png',
  ...
  // --- Different Art Mediums ---
  {
    ...
    image: '/images/different_art_mediums.png',
  ...
  // --- Mixed Work ---
  {
    ...
    category: 'Mixed Work',
    image: '/images/mixed_work_collage.png',
...
export const CATEGORIES: { id: string; name: CategoryType; image: string }[] = [
  { id: 'product', name: 'Product Design', image: '/images/product_1_books_key_holder.png' },
  { id: 'posters', name: 'Posters & Typography', image: '/images/posters_overview.png' },
  { id: 'fashion', name: 'Fashion Design', image: '/images/fashion_navi_vogue.png' },
  { id: 'model', name: 'Model Making', image: '/images/model_making.png' },
  { id: 'art', name: 'Different Art Mediums', image: '/images/different_art_mediums.png' },
  { id: 'sketches', name: 'Rough Sketches', image: '/images/rough_sketches_1.png' },
  { id: 'mixed', name: 'Mixed Work', image: '/images/mixed_work_collage.png' },
];
